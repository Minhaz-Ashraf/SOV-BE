...
export const VisaSchema = z.object({
  ...
  offerLetter: z.string().nonempty("Offer letter is required"),
  gicLetter: z.string().nonempty("GIC letter is required"),
  medical: z.string().nonempty("Medical document is required"),
