...
router.route("/all-agent").get( getAllAgent)  
...
router.route("/sub-admin/applications").get(verifyAdmin, getAllApplicationsForSubadmin)
router.route("/sub-admin/student-agent-data").get(verifyAdmin, getAllDataAgentStudentForSubadmin)
